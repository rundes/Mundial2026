...
const CACHE_VERSION = 'album-2026-v2.0.0';
const URLS_A_CACHEAR = [
  './',
  './index.html',
  './manifest.webmanifest?v=2.0.0',
  './icons/icon-100.png?v=2.0.0',
  './icons/icon-180.png?v=2.0.0',
  './icons/icon-192.png?v=2.0.0',
  './icons/icon-512.png?v=2.0.0',
  './icons/icon-192-maskable.png?v=2.0.0',
  './icons/icon-512-maskable.png?v=2.0.0',
];
